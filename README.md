...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cdcs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9031&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cdcs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cdcs` can be installed with:

```
conda install cdcs
```

It is possible to list all of the versions of `cdcs` available on your platform with:
